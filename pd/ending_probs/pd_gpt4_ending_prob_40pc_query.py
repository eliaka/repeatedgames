...
question = "You are playing a game repeatedly with another player. In this game, you can choose between Option J and Option F.\n"\
        f"You will play an indefinite number of rounds in total with the same player. There is a 40% probability that the game will end after each round.\n"\
...
df.to_csv('data/pd_gpt4_40p.csv', index=False)