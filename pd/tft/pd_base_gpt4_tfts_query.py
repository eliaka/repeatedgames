...
player_1 = [act_gpt4, act_tft, act_tftt, act_stft, act_rtft, act_htft, act_np10, act_np20]
player_2 = [act_gpt4, act_tft, act_tftt, act_stft, act_rtft, act_htft, act_np10, act_np20]
...
df.to_csv('data/pd_base_gpt4_tfts.csv', index=False)