...
def calculate_points(strategy1, strategy2):
    if strategy1 == strategy2:
        if strategy1 == "J" and strategy2 == "J":
            ...
            return 8, 8
        elif strategy1 == "2" and strategy2 == "2":
            return 5, 5
        else:
            return -9999, -9999
...
outcomes = ["credits", "reputation points", "bonus rewards"]

for options in option_variations:
    for outcome in outcomes:

        question = "You are working on a collaborative project with another colleague. In this project, you can choose between Approach " + options[0] + " and Approach " + options[1] + ". "\
            f"You will work on {num_interactions} tasks in total with the same colleague. "\
            "The guidelines of the project are as follows:\n"\
            "If you choose Approach " + options[0] + " and the other colleague chooses Approach " + options[0] + ", then you win 8 " + outcome + " and the other colleague wins 8 " + outcome + ".\n"\
            "If you choose Approach " + options[0] + " and the other colleague chooses Approach " + options[1] + ", then you win 0 " + outcome + " and the other colleague wins 10 " + outcome + ".\n"\
            "If you choose Approach " + options[1] + " and the other colleague chooses Approach " + options[0] + ", then you win 10 " + outcome + " and the other colleague wins 0 " + outcome + ".\n"\
            "If you choose Approach " + options[1] + " and the other colleague chooses Approach " + options[1] + ", then you win 5 " + outcome + " and the other colleague wins 5 " + outcome + ".\n\n"
        ...
        for i in range(1, num_interactions+1, 1):
            ...
            answer_gpt = act_gpt4(question + conversation_history_for_gpt + f"You are currently working on task {i}.\nQ: Which Approach do you choose, Approach " + option_1 + " or Approach " + option_2 + "?\nA: Approach")
            ...
            conversation_history_for_gpt += f"In project {i}, you chose Approach " + answer_gpt + " and the other colleague chose Approach " + answer_other + f". Thus, you won {score_gpt} " + outcome + f" and the other colleague won {score_other} " + outcome + ".\n"
...
df.to_csv('data/experiment_robustness_checks_project.csv', index=False)
