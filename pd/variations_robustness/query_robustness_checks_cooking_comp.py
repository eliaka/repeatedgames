...
for options in option_variations:
    for outcome in outcomes:
        ...
        question = "ou are participating in a cooking competition with another contestant. In this competition, you can choose between Recipe " + options[0] + " and Recipe " + options[1] + ". "\
            f"You will prepare {num_interactions} dishes in total with the same contestant. "\
            "The competition rules are as follows:\n"\
            "If you choose Recipe " + options[0] + " and the other contestant chooses Recipe " + options[0] + ", then you win 8 " + outcome + " and the other contestant wins 8 " + outcome + ".\n"\
            "If you choose Recipe " + options[0] + " and the other contestant chooses Recipe " + options[1] + ", then you win 0 " + outcome + " and the other contestant wins 10 " + outcome + ".\n"\
            "If you choose Recipe " + options[1] + " and the other contestant chooses Recipe " + options[0] + ", then you win 10 " + outcome + " and the other contestant wins 0 " + outcome + ".\n"\
            "If you choose Recipe " + options[1] + " and the other contestant chooses Recipe " + options[1] + ", then you win 5 " + outcome + " and the other contestant wins 5 " + outcome + ".\n\n"
