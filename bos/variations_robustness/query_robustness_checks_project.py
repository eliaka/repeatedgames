...
for options in option_variations:
    for outcome in outcomes:
        ...
        question = "You are working on a collaborative project with another colleague. In this project, you can choose between Approach " + options[0] + " and Approach " + options[1] + ". "\
            ...
            "If you choose Approach " + options[0] + " and the other colleague chooses Approach " + options[0] + ", then you win 10 " + outcome + " and the other colleague wins 7 " + outcome + ".\n"\
            "If you choose Approach " + options[0] + " and the other colleague chooses Approach " + options[1] + ", then you win 0 " + outcome + " and the other colleague wins 0 " + outcome + ".\n"\
            "If you choose Approach " + options[1] + " and the other colleague chooses Approach " + options[0] + ", then you win 0 " + outcome + " and the other colleague wins 0 " + outcome + ".\n"\
            "If you choose Approach " + options[1] + " and the other colleague chooses Approach " + options[1] + ", then you win 7 " + outcome + " and the other colleague wins 10 " + outcome + ".\n\n"
