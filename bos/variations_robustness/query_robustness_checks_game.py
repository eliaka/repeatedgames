...
for options in option_variations:
    for outcome in outcomes:
        ...
        question = "You are playing a game repeatedly with another player. In this game, you can choose between Option " + options[0] + " and Option " + options[1] + ". "\
            ...
            "If you choose Option " + options[0] + " and the other player chooses Option " + options[0] + ", then you win 10 " + outcome + " and the other player wins 7 " + outcome + ".\n"\
            "If you choose Option " + options[0] + " and the other player chooses Option " + options[1] + ", then you win 0 " + outcome + " and the other player wins 0 " + outcome + ".\n"\
            "If you choose Option " + options[1] + " and the other player chooses Option " + options[0] + ", then you win 0 " + outcome + " and the other player wins 0 " + outcome + ".\n"\
            "If you choose Option " + options[1] + " and the other player chooses Option " + options[1] + ", then you win 7 " + outcome + " and the other player wins 10 " + outcome + ".\n\n"
